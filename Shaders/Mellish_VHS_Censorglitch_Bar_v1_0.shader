...
Shader "Mellish/VHS Censorglitch/Bar v1.0"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float rgb = (_RGBSplit * distanceFade) * (0.35 + crushed + abs(rowJitter));
                ...
                col += crushed * 0.22 * distanceFade;
                col += breaks * 0.15 * distanceFade;
                ...
                float alpha = _Opacity * edgeFade * distanceFade;
